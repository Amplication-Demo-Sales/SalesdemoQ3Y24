...
import { BookingWhereInput } from "../../booking/base/BookingWhereInput";
...
export class RoomControllerBase {
  ...
  async SearchAvailableRooms(
    @common.Body()
    body: BookingWhereInput
  ): Promise<Booking[]> {
    return this.service.SearchAvailableRooms(body);
  }
}
