...
export class BookingResolverBase {
  ...
  async getGuest(@graphql.Parent() parent: Booking): Promise<Guest | null> {
  ...
  @graphql.Mutation(() => DeleteBookingArgs)
  async CancelReservation(
    @graphql.Args()
    args: BookingFindUniqueArgs
  ): Promise<DeleteBookingArgs> {
    return this.service.CancelReservation(args);
  }
  ...
  async GetReservation(
    ...
    return this.service.GetReservation(args);
  }
}
